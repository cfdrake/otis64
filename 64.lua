...
function grid_key(x, y, z)
  ...
  if x == 2 and y == 1 and z == 1 then
    softcut.rec(1, 0)
    rec1 = false
  elseif x == 2 and y == 5 and z == 1 then
    softcut.rec(2, 0)
    rec2 = false
  end
  ...
  if x == 4 and y == 1 and z == 1 then
    flip(1)
  elseif x == 4 and y == 5 and z == 1 then
    flip(2)
  end
  ...
  if x == 8 and y == 1 and z == 1 then
    softcut.buffer_clear_channel(1)
  elseif x == 8 and y == 5 and z == 1 then
    softcut.buffer_clear_channel(2)
  end
...
function draw_grid()
  ...
  g:led(3, params:get("1lfo") == 2 and 7 or 8, 15)
  g:led(4, params:get("2lfo") == 2 and 7 or 8, 15)
  g:led(5, params:get("3lfo") == 2 and 7 or 8, 15)
  g:led(6, params:get("4lfo") == 2 and 7 or 8, 15)
